    ...
    <div class="ml-2 mt-4 flex flex-col">
      <div class="flex items-center gap-2">
        <div
          :class="[
            'h-6 w-6',
            hasAtLeastOneDigit ? 'i-ph-check-circle text-primary-500' : 'i-ph-circle-dashed text-gray',
          ]"
        />
      ...
      <div class="flex items-center gap-2">
        <div
          :class="[
            'h-6 w-6',
            hasAtLeastOneLowercaseLetter ? 'i-ph-check-circle text-primary-500' : 'i-ph-circle-dashed text-gray',
          ]"
        />
      ...
      <div class="flex items-center gap-2">
        <div
          :class="[
            'h-6 w-6',
            hasAtLeastOneUppercaseLetter ? 'i-ph-check-circle text-primary-500' : 'i-ph-circle-dashed text-gray',
          ]"
        />
      ...
      <div class="flex items-center gap-2">
        <div
          :class="[
            'h-6 w-6',
            hasAtLeastOneSpecialCharacter ? 'i-ph-check-circle text-primary-500' : 'i-ph-circle-dashed text-gray',
          ]"
        />
